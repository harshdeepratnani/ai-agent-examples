...
st.set_page_config(page_title="SwiftLife Insurance Agent", page_icon="🤖")
...
# Streamlit UI
st.markdown("<h1>🤖 SwiftLife Insurance Agent</h1>", unsafe_allow_html=True)
st.write("Ask me anything about life insurance or schedule an appointment!")
...
if user_input:
    ...
    formatted_response = markdown_to_html_links(response)
