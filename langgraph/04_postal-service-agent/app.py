...
st.set_page_config(page_title="Swift Postal Service Agent", page_icon="🤖")
...
# Streamlit UI
st.markdown("<h1>🤖 Swift Postal Service Agent</h1>", unsafe_allow_html=True)
st.write("Ask me anything about Swift Postal Service or place an order!")
